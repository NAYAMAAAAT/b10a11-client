        ...
        <footer className="bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300 py-6">
            <div className="container mx-auto px-6">
                ...
                <div className="text-center mb-4">
                    <h1 className="text-2xl font-bold">Guideline Grove</h1>
                    <p>&copy; {new Date().getFullYear()} Guideline Grove. All Rights Reserved.</p>
                </div>

                {/* Contact Information */}
                <div className="text-center mb-4">
                    <p>Email: <a href="mailto:support@movieportal.com" className="text-blue-500 hover:underline">support@Guideline Grove.com</a></p>
                ...
                <div className="flex justify-center space-x-6">
                 ...
                 <div className="text-center mt-4">
                    <p className="text-sm">Made with 💙 by Guideline Grove Team</p>
                </div>
            </div>
        </footer>
    );
